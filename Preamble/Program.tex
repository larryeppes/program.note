...
\newtcbinputlisting{\inputcode}[2][]{%
  listing engine=minted,minted language=#1,minted style=friendly,%manni, igor, lovelace, xcode, vim, autumn, vs, rrt, 
...
\newtcblisting{shell}{listing engine=minted,minted style=emacs,
  ...
  colback=gray!80!black!30,colframe=gray!75!black,listing only,breakable,
  left=5mm,enhanced}
